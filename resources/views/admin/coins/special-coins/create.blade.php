...
@section('main-content')
    <section class="section">
        <div class="section-header">
            <h1>Create Special Coin</h1>
            <div class="section-header-breadcrumb">
                <div class="breadcrumb-item active"><a href="{{ route('admin.home') }}">Dashboard</a></div>
                <div class="breadcrumb-item"><a href="{{ route('special-coins.index') }}">Special Coins</a></div>
                <div class="breadcrumb-item">Create New Special Coin</div>
            </div>
        </div>
            ...
            <div class="row justify-content-center">
                <div class="col-md-9">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('special-coins.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="form-row">
                                    <div class="col-md-6">
                                ...
                                <div class="form-group d-flex justify-content-end">
                                    <button class="btn btn-primary" type="submit">Create Special Coins</button>
                                </div>
                            </form>
                        </div>
                    </div>
