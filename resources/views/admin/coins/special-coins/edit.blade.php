    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item">Edit Special Coin</div>
            </div>
        </div>
            ...
            <div class="row justify-content-center">
                <div class="col-md-9">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('special-coins.update', $coin->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('put')
                                <div class="form-row">
                                    <div class="col-md-6">
                                ...
                                <div class="form-group d-flex justify-content-end">
                                    <button class="btn btn-primary" type="submit">Update Special Coins</button>
                                </div>
                            </form>
                        </div>
                    </div>
