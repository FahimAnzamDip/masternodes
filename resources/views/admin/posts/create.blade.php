            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('posts.store') }}" id="post-form" method="POST"
                                ...
                                <div class="form-row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input id="post_title" type="text" class="form-control" required name="post_title" value="{{ old('post_title') }}" placeholder="Enter post title">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input id="slug" type="text" class="form-control" required name="slug" value="{{ old('slug') }}" placeholder="Enter post slug">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control selectric" required name="post_status">
                                                ...
                                                <option value="1" {{ old('post_status') == 1 ? 'selected' : '' }}>
                                                    Publish
                                                </option>
                                                <option value="2" {{ old('post_status') == 2 ? 'selected' : '' }}>
                                                    Draft
                                                </option>
                                            </select>
                                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea id="editor" name="post_content">{{ old('post_content') }}</textarea>
                                </div>
                                <div class="form-group">
                                    <label>Tags (press comma "," after every tag or click)<span class="text-danger">*</span></label>
                                    <input type="text" class="form-control inputtags" name="post_tags" value="{{ old('post_tags') }}" placeholder="Enter post tags">
                                </div>
                                <div class="form-group">
